...
const items = [
  ...
  { icon: BarChart3, title: 'Roth Conversion Roadmap', desc: 'Year-by-year conversion schedule targeting optimal tax brackets through age 73, calibrated to avoid IRMAA surcharges.' },
  { icon: Wallet, title: 'Retirement Income Distribution', desc: 'Bucket-style withdrawal strategy coordinating Social Security (Sept 2026), pension (2028), and portfolio withdrawals to age 100.' },
  { icon: PieChart, title: 'Asset Allocation & Rebalancing', desc: 'Transition from 81/19 to diversified 60/40 with proper international exposure and lower expense ratios.' },
  { icon: Receipt, title: 'Tax Projection & Coordination', desc: 'Annual tax estimates incorporating Roth conversions, RMDs, and Social Security taxation. Coordinate with your tax preparer.' },
  { icon: ShieldCheck, title: 'Insurance & Risk Assessment', desc: "Evaluate long-term care exposure given family longevity (planning to 100). Review homeowner's coverage." },
  { icon: Monitor, title: 'RightCapital Dashboard Access', desc: 'Full access to your interactive financial plan to run scenarios, track progress, and view live projections.' },
];

export default function Slide07Scope() {
  return (
